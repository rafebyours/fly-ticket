  ...
  <MainLayout>
    <transition name="fade" @before-enter="beforeEnter" @enter="enter" @leave="leave">
      ...
      <div class="flex flex-col items-center justify-center min-h-screen bg-white">
        ...
        <!-- Ticket Container -->
        <div v-if="transaction" class="w-80 bg-white rounded-2xl overflow-hidden mt-4 mb-6 shadow-xl">
          ...
          <div class="px-6 py-4">
            ...
            <p><strong>{{ transaction.selectedCard.location }}</strong></p>
            <p><strong>Date & Time:</strong></p>
            <p><strong>{{ transaction.selectedCard.date }} at {{ transaction.selectedCard.time }}</strong></p>
            <p><strong>Total Tickets:</strong> {{ transaction.reservationSummary.people }}</p>
            <p><strong>Total Payment:</strong> </p>
            <p><strong>Rp. {{ formatPrice(transaction.grandTotal) }}</strong></p>
